...
interface ICRWDClearing {
    ...
    function clearMintFundsFromCrowdsale(address _to, uint256 _amount) external returns (bool); //from Crowdsale
    function mintFromCrowdsale(address _to, uint256 _amount) external returns (bool); //from Crowdsale
}